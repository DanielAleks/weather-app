 const loadImages = ({condition, setImageState}) => {
  switch (condition) {
    ...
    default:
      setImageState('https://images.unsplash.com/photo-1476842634003-7dcca8f832de?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80')
  }
} 
